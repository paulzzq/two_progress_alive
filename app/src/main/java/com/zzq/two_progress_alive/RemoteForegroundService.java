...
public class RemoteForegroundService extends Service {
    ...
    class MyBinder extends IMyAidlInterface.Stub {
        ...
        public void basicTypes(
            ...
            // 通信内容
            Log.e("eee","--------RemoteForegroundService----basicTypes:"+aString);

        }

        @Override
        public void getId(String uid) throws RemoteException {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.e("eee","-----------remote----onStartCommand");
        // 绑定另外一个服务
        bindService();
        if(testThread==null){
        ...
        public void run() {
            ...
            while (true){
                try {
                    Thread.sleep(2000);
                    Log.e("eee","---remote运行中");
//                    myBinder.basicTypes(1,2,false,3,4,"remote");
    ...
    class Connection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            try {
                binder.basicTypes(1,2,false,3,4,"remote");
